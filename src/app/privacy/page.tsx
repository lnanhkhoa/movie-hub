...
export const metadata: Metadata = {
  title: 'Privacy Policy - Movie Hub',
  description: 'Privacy Policy for Movie Hub',
}
          ...
          <div className="max-w-3xl mx-auto space-y-6 md:space-y-8">
            ...
            <div className="prose prose-invert max-w-none space-y-6">
              ...
              <section className="space-y-4">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  We use your information to provide personalized recommendations, save your watchlist, and improve your overall experience on Movie Hub. We do not sell your personal information to third parties.
                </p>
              </section>
              ...
              <section className="space-y-4">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  We use Google OAuth for authentication. When you sign in with Google, you agree to Google&apos;s privacy policy and terms of service. Movie Hub only receives the information you authorize Google to share with us.
                </p>
              </section>
              ...
              <section className="space-y-4">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  You have the right to access, update, or delete your personal information. You can do this by accessing your profile settings or contacting us directly.
                </p>
              </section>
