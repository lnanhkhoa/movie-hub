...
export const metadata: Metadata = {
  title: 'Terms of Service - Theta Movies',
  description: 'Terms of Service for Theta Movies'
}
            ...
            <div className="prose prose-invert max-w-none space-y-6">
              ...
              <section className="space-y-4">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  By accessing and using Theta Movies, you accept and agree to be bound by the terms
              ...
              <section className="space-y-4">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Theta Movies is a free streaming platform. You may use our service subject to
                  these terms and applicable law. You are responsible for any activity that occurs
                  under your account.
                </p>
              </section>
              ...
              <section className="space-y-4">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  All content available on Theta Movies, including but not limited to text,
                  graphics, logos, and software, is the property of Theta Movies or its content
